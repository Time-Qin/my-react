(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.testUtils = {}, global.React, global.scheduler));
	...
	// 删除节点及其子树
	function commitDeteion(childToDelete, root) {
	    {
	...
	const commitHookEffectListUnmount = (tags, lastEffect) => {
	...
	const commitHookEffectListDestroy = (tags, lastEffect) => {
	    commitHookEffectList(tags, lastEffect, (effect) => {
	        const destroy = effect.destroy;
	        if (typeof destroy === 'function') {
	            destroy();
	...
	const commitHookEffectListCreate = (tags, lastEffect) => {
	    commitHookEffectList(tags, lastEffect, (effect) => {
	...
	// 用于触发状态更新的逻辑
	function dispatchSetState(fiber, updateQueue, queue) {
